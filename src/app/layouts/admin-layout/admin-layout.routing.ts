...
export const AdminLayoutRoutes: Routes = [
    ...
    { path: 'AddDieta',  component: AddDietaComponent ,canActivate: [AuthGuard, AdminGuard]},
    { path: 'AddRutina',  component: AddRutinaComponent ,canActivate: [AuthGuard, AdminGuard]},
    { path: 'VerRutina',  component: VerRutinasComponent ,canActivate: [AuthGuard, AdminGuard]},
    { path: 'VerDieta',  component: VerDietasComponent ,canActivate: [AuthGuard, AdminGuard]},
